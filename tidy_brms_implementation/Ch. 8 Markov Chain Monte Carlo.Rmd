...
To alter an existing brms fit, you can use `update()`, which will substantially quicken the time it takes to run.

```{r, message = F, results = "hide"}
b8.1_4chains_4cores <- update(b8.1, chains = 4, cores = 4)
```
